...
<form method="POST" action="/content-groups/<?= $group['id'] ?>/edit" class="group-form">
    ...
    <div class="form-group">
        ...
        <div style="display: flex; flex-direction: column; gap: 0.75rem; margin-top: 0.5rem;">
            <label style="display: flex; align-items: center; cursor: pointer;">
                <input type="radio" name="use_auto_generation" value="0" <?= empty($group['use_auto_generation']) || $group['use_auto_generation'] == '0' ? 'checked' : '' ?> style="margin-right: 0.5rem;">
                <span>📝 Использовать шаблон (если выбран)</span>
            </label>
            <label style="display: flex; align-items: center; cursor: pointer;">
                <input type="radio" name="use_auto_generation" value="1" <?= !empty($group['use_auto_generation']) && $group['use_auto_generation'] == '1' ? 'checked' : '' ?> style="margin-right: 0.5rem;">
    ...
    <div class="form-group" id="template_group" style="<?= !empty($group['use_auto_generation']) && $group['use_auto_generation'] != '0' ? 'display: none;' : '' ?>">
